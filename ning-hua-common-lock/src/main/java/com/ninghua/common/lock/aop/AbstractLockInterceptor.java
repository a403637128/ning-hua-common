...
import com.ninghua.common.lock.util.ThrowableFunction;
import lombok.*;
...
public abstract class AbstractLockInterceptor implements InitializingBean, ApplicationContextAware, Lock4jMethodInterceptor {
