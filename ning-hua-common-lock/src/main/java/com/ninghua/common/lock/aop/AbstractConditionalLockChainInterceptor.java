...
import com.ninghua.common.lock.MethodBasedExpressionEvaluator;
 ...
 * @Author Derek.Fung
 * @Date 2025/6/24 17:48
 **/
public abstract class AbstractConditionalLockChainInterceptor extends AbstractConditionalLockInterceptor{

    public AbstractConditionalLockChainInterceptor(MethodBasedExpressionEvaluator methodBasedExpressionEvaluator) {
